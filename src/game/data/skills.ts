...
export const skills: readonly Skill[] = [
  { id: "slash", name: "참격", type: "attack", damage: 10, effect: "slash" },
  { id: "fire-slash", name: "화염참격", type: "attack", damage: 25, effect: "fireSlash" },
  { id: "inferno-slash", name: "폭염연옥참", type: "attack", damage: 50, effect: "heavySlash" },
